...
Source0  : https://github.com/libical/libical/releases/download/v3.0.3/libical-3.0.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1522111085
mkdir clr-build
pushd clr-build
...
/usr/lib64/libical-glib.so.3.0.3
