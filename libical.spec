...
Source0  : https://github.com/libical/libical/archive/v3.0.20/libical-3.0.20.tar.gz
...
%prep
%setup -q -n libical-3.0.20
cd %{_builddir}/libical-3.0.20
pushd ..
cp -a libical-3.0.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742421066
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libical-glib.so.3.0.20
/V3/usr/lib64/libical.so.3.0.20
/V3/usr/lib64/libical_cxx.so.3.0.20
/V3/usr/lib64/libicalss.so.3.0.20
/V3/usr/lib64/libicalss_cxx.so.3.0.20
/V3/usr/lib64/libicalvcal.so.3.0.20
/usr/lib64/libical-glib.so.3
/usr/lib64/libical-glib.so.3.0.20
