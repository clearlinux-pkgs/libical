...
Source0  : https://github.com/libical/libical/archive/v3.0.7/libical-3.0.7.tar.gz
Summary  : An open source reference implementation of the icalendar data type and serialization format
Group    : Development/Tools
License  : LGPL-2.1 MPL-2.0 MPL-2.0-no-copyleft-exception
...
%prep
%setup -q -n libical-3.0.7
cd %{_builddir}/libical-3.0.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576612682
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libical-3.0.7/COPYING %{buildroot}/usr/share/package-licenses/libical/3bf3cf94d36c740565ea0b38105f1dc5ee25c695
cp %{_builddir}/libical-3.0.7/LICENSE %{buildroot}/usr/share/package-licenses/libical/e06cc15cb9b44cb1aa2f5210a92baa95ceb2978e
cp %{_builddir}/libical-3.0.7/LICENSE.LGPL21.txt %{buildroot}/usr/share/package-licenses/libical/3f96533507f18e90b0358965251430691823209a
cp %{_builddir}/libical-3.0.7/LICENSE.MPL2.txt %{buildroot}/usr/share/package-licenses/libical/d7e3ed5ac149ac1e2d2e0f4daff081c1dafef1c0
pushd clr-build
%make_install
popd
...
/usr/lib64/libical-glib.so.3.0.7
/usr/lib64/libical.so.3
/usr/lib64/libical.so.3.0.7
/usr/lib64/libical_cxx.so.3
/usr/lib64/libical_cxx.so.3.0.7
/usr/lib64/libicalss.so.3
/usr/lib64/libicalss.so.3.0.7
/usr/lib64/libicalss_cxx.so.3
/usr/lib64/libicalss_cxx.so.3.0.7
/usr/lib64/libicalvcal.so.3
/usr/lib64/libicalvcal.so.3.0.7
