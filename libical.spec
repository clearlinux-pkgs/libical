...
Source0  : https://github.com/libical/libical/archive/v3.0.14/libical-3.0.14.tar.gz
...
%prep
%setup -q -n libical-3.0.14
cd %{_builddir}/libical-3.0.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644177074
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libical-3.0.14/COPYING %{buildroot}/usr/share/package-licenses/libical/3bf3cf94d36c740565ea0b38105f1dc5ee25c695
cp %{_builddir}/libical-3.0.14/LICENSE %{buildroot}/usr/share/package-licenses/libical/e06cc15cb9b44cb1aa2f5210a92baa95ceb2978e
cp %{_builddir}/libical-3.0.14/LICENSE.LGPL21.txt %{buildroot}/usr/share/package-licenses/libical/3f96533507f18e90b0358965251430691823209a
cp %{_builddir}/libical-3.0.14/LICENSE.MPL2.txt %{buildroot}/usr/share/package-licenses/libical/d7e3ed5ac149ac1e2d2e0f4daff081c1dafef1c0
cp %{_builddir}/libical-3.0.14/debian/copyright %{buildroot}/usr/share/package-licenses/libical/8c589624765e6a849a00a07166fafe0e2f8dd463
pushd clr-build
%make_install
popd
