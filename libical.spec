...
Version  : 3.0.15
Release  : 30
URL      : https://github.com/libical/libical/archive/v3.0.15/libical-3.0.15.tar.gz
Source0  : https://github.com/libical/libical/archive/v3.0.15/libical-3.0.15.tar.gz
...
%prep
%setup -q -n libical-3.0.15
cd %{_builddir}/libical-3.0.15
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665078887
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libical-glib.so.3.0.15
/usr/lib64/libical.so.3
/usr/lib64/libical.so.3.0.15
/usr/lib64/libical_cxx.so.3
/usr/lib64/libical_cxx.so.3.0.15
/usr/lib64/libicalss.so.3
/usr/lib64/libicalss.so.3.0.15
/usr/lib64/libicalss_cxx.so.3
/usr/lib64/libicalss_cxx.so.3.0.15
/usr/lib64/libicalvcal.so.3
/usr/lib64/libicalvcal.so.3.0.15
