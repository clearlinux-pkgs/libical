...
Version  : 3.0.19
Release  : 38
URL      : https://github.com/libical/libical/archive/v3.0.19/libical-3.0.19.tar.gz
Source0  : https://github.com/libical/libical/archive/v3.0.19/libical-3.0.19.tar.gz
...
%prep
%setup -q -n libical-3.0.19
cd %{_builddir}/libical-3.0.19
pushd ..
cp -a libical-3.0.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735084212
mkdir -p clr-build
pushd clr-build
...
export GOAMD64=v2
%cmake .. -DGOBJECT_INTROSPECTION=true -DICAL_GLIB_VAPI=true  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libical-glib.so.3.0.19
/V3/usr/lib64/libical.so.3.0.19
/V3/usr/lib64/libical_cxx.so.3.0.19
/V3/usr/lib64/libicalss.so.3.0.19
/V3/usr/lib64/libicalss_cxx.so.3.0.19
/V3/usr/lib64/libicalvcal.so.3.0.19
/usr/lib64/libical-glib.so.3
/usr/lib64/libical-glib.so.3.0.19
/usr/lib64/libical.so.3
/usr/lib64/libical.so.3.0.19
/usr/lib64/libical_cxx.so.3
/usr/lib64/libical_cxx.so.3.0.19
/usr/lib64/libicalss.so.3
/usr/lib64/libicalss.so.3.0.19
/usr/lib64/libicalss_cxx.so.3
/usr/lib64/libicalss_cxx.so.3.0.19
/usr/lib64/libicalvcal.so.3
/usr/lib64/libicalvcal.so.3.0.19
