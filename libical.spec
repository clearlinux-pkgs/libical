...
Version  : 3.0.9
Release  : 23
URL      : https://github.com/libical/libical/archive/v3.0.9/libical-3.0.9.tar.gz
Source0  : https://github.com/libical/libical/archive/v3.0.9/libical-3.0.9.tar.gz
...
%prep
%setup -q -n libical-3.0.9
cd %{_builddir}/libical-3.0.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610997392
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libical-3.0.9/COPYING %{buildroot}/usr/share/package-licenses/libical/3bf3cf94d36c740565ea0b38105f1dc5ee25c695
cp %{_builddir}/libical-3.0.9/LICENSE %{buildroot}/usr/share/package-licenses/libical/e06cc15cb9b44cb1aa2f5210a92baa95ceb2978e
cp %{_builddir}/libical-3.0.9/LICENSE.LGPL21.txt %{buildroot}/usr/share/package-licenses/libical/3f96533507f18e90b0358965251430691823209a
cp %{_builddir}/libical-3.0.9/LICENSE.MPL2.txt %{buildroot}/usr/share/package-licenses/libical/d7e3ed5ac149ac1e2d2e0f4daff081c1dafef1c0
cp %{_builddir}/libical-3.0.9/debian/copyright %{buildroot}/usr/share/package-licenses/libical/8c589624765e6a849a00a07166fafe0e2f8dd463
pushd clr-build
%make_install
popd
...
/usr/lib64/libical-glib.so.3.0.9
/usr/lib64/libical.so.3
/usr/lib64/libical.so.3.0.9
/usr/lib64/libical_cxx.so.3
/usr/lib64/libical_cxx.so.3.0.9
/usr/lib64/libicalss.so.3
/usr/lib64/libicalss.so.3.0.9
/usr/lib64/libicalss_cxx.so.3
/usr/lib64/libicalss_cxx.so.3.0.9
/usr/lib64/libicalvcal.so.3
/usr/lib64/libicalvcal.so.3.0.9
