...
Source0  : https://github.com/libical/libical/releases/download/v3.0.0/libical-3.0.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1509298058
mkdir clr-build
pushd clr-build
...
/usr/lib64/libical-glib.so.3.0.0
/usr/lib64/libical.so.3
/usr/lib64/libical.so.3.0.0
/usr/lib64/libical_cxx.so.3
/usr/lib64/libical_cxx.so.3.0.0
/usr/lib64/libicalss.so.3
/usr/lib64/libicalss.so.3.0.0
/usr/lib64/libicalss_cxx.so.3
/usr/lib64/libicalss_cxx.so.3.0.0
/usr/lib64/libicalvcal.so.3
/usr/lib64/libicalvcal.so.3.0.0
