...
%prep
%setup -q -n libical-3.0.8
cd %{_builddir}/libical-3.0.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583768211
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libical-3.0.8/COPYING %{buildroot}/usr/share/package-licenses/libical/3bf3cf94d36c740565ea0b38105f1dc5ee25c695
cp %{_builddir}/libical-3.0.8/LICENSE %{buildroot}/usr/share/package-licenses/libical/e06cc15cb9b44cb1aa2f5210a92baa95ceb2978e
cp %{_builddir}/libical-3.0.8/LICENSE.LGPL21.txt %{buildroot}/usr/share/package-licenses/libical/3f96533507f18e90b0358965251430691823209a
cp %{_builddir}/libical-3.0.8/LICENSE.MPL2.txt %{buildroot}/usr/share/package-licenses/libical/d7e3ed5ac149ac1e2d2e0f4daff081c1dafef1c0
pushd clr-build
%make_install
popd
...
/usr/lib64/libical-glib.so.3.0.8
/usr/lib64/libical.so.3
/usr/lib64/libical.so.3.0.8
/usr/lib64/libical_cxx.so.3
/usr/lib64/libical_cxx.so.3.0.8
/usr/lib64/libicalss.so.3
/usr/lib64/libicalss.so.3.0.8
/usr/lib64/libicalss_cxx.so.3
/usr/lib64/libicalss_cxx.so.3.0.8
/usr/lib64/libicalvcal.so.3
/usr/lib64/libicalvcal.so.3.0.8
